...
const PcCartReducer = (st = cart, action) => {
...
const PcUserReducer = (st = userState, action) => {
  switch (action.type) {
...
const PcCrntPrdtReducer = (state = crntPrdtState, action) => {
  switch (action.type) {
...
const PcToggleFav = (state = FavItems, action) => {
  switch (action.type) {
